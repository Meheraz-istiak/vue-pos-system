  ...
  },
  {
    ...
    children: [
...

      {
        path: "role",
        name: "role",
        component: () => import("@/views/user-management/role/index.vue"),
      },

      {
        path: "lookups",
        name: "lookups",
        component: () => import("@/views/modules/lookups/index.vue"),
...

      {
        path: "workgroup",
        name: "workgroup",
        component: () => import("@/views/modules/workgroup/index.vue"),
      },
